...
def generar_pdf(datos, carpeta):
    ...
    elementos = [
        Paragraph("DIRECCIÓN DE INGENIERÍA MUNICIPAL · RIF G-20002924-2", ParagraphStyle("Dep", parent=styles["Normal"], fontName="Times-Bold", fontSize=9.5, textColor=c_azul)),
        Spacer(1, 4),
    ...
    if fotos_galeria:
        ...
        # Fotos más grandes: antes 5.6x4.2 cm en 3 columnas, ahora 8.6x6.4 cm en 2 columnas
        ANCHO_GALERIA, ALTO_GALERIA = 8.6 * cm, 6.4 * cm
        celdas = []
        ...
        t_galeria = Table(filas_galeria, colWidths=[8.95 * cm, 8.95 * cm])
