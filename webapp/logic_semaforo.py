...
def generar_pdf(datos, carpeta):
    ...
    elementos = [
        Paragraph("DIRECCIÓN DE VIVIENDA Y HÁBITAT · RIF G-20002924-2", ParagraphStyle("Dep", parent=styles["Normal"], fontName="Times-Bold", fontSize=9.5, textColor=c_azul)),
        Spacer(1, 4),
    ...
    for clave, nombre in ESPACIOS_REGULARES:
        info = datos["espacios"].get(clave, {"estructural": [], "no_estructural": [], "cantidades_estructural": {}, "nota": "", "foto": None})
