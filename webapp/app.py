...
from logic_informe import generar_informe_docx
...
def informe_nuevo():
    ...
    data = {
        ...
        "obs_estructura": f.get("obs_estructura", ""),
        "obs_techo": f.get("obs_techo", ""),
        "obs_electricas": f.get("obs_electricas", ""),
        "obs_sanitarias": f.get("obs_sanitarias", ""),
        "obs_acabados": f.get("obs_acabados", ""),
        "recomendaciones": [
