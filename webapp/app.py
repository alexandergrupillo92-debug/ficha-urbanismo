...
# se descarga tal cual — no lleva fotos ni menús desplegables)
# ============================================================
@app.route("/ficha_familiar")
def ficha_familiar():
    ruta = os.path.join(app.root_path, "assets", "ficha_familiar.docx")
    return send_file(
        ruta,
        as_attachment=True,
        download_name="Ficha_Familiar_Habitat_Vivienda.docx",
    )
